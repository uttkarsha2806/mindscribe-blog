...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen mt-20">
      <div className="flex p-3 max-w-4xl mx-auto flex-col md:flex-row md:items-center gap-7">
        {/* left */}
        <div className="flex-1">
          ...
          <p className="text-lg pl-2 mt-5">Welcome Back!</p>
          <p className="text-md pl-2 mt-5">
            Sign in to continue exploring our exclusive collection of insightful
            blog posts.
          </p>
        </div>
        {/* right */}
